...
// Product data generator based on appliance type and ID
const generateProductData = (applianceType: string, productId: string) => {
  ...
  // Extract number from productId (e.g., "ac-1" -> 1)
  const productIndex = parseInt(productId.split("-").pop() || "1") - 1;

  // Generate consistent data based on product index
...
const ProductDetailPage = ({ params }) => {
  // Extract slug and id from params (Next.js would provide this)
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div className="mb-6">
              <span className="text-sm text-blue-600 mb-2 block font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="flex-1 px-6 py-3 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 transition-colors font-semibold">
                Find Best Price
              </button>
